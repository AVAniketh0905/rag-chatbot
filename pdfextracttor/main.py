...
docs = [
    Docs("static/rbicirc/KYCMDfull.pdf", (0, 2)),
    Docs("static/rbicirc/MDAccesscrtpayments.pdf", (1, 2)),
]
...
def main():
    docs = [
        Doc("static/rbicirc/KYCMDfull.pdf", 3, 96),
        Doc("static/rbicirc/McircBaselIIIcapreg.pdf", 6, 297),
        Doc("static/rbicirc/MDAccesscrtpayments.pdf", 3, 57),
        Doc("static/rbicirc/MDBBPS.pdf", 1),
        Doc("static/rbicirc/MDCapreqOprisk.pdf", 1),
        Doc("static/rbicirc/MDcounterfietnotes.pdf", 3, 25),
        Doc("static/rbicirc/MDcrdrcardissuance.pdf", 1, 35),
        Doc("static/rbicirc/MDCRRSLR.pdf", 1, 84),
        Doc("static/rbicirc/MDdigipaysecontrols.pdf", 3),
        Doc("static/rbicirc/MDexchngofnotes.pdf", 1),
        Doc("static/rbicirc/MDfemaborrlendngnrisres.pdf", 3, 11),
        Doc("static/rbicirc/MDfemadepnaccts.pdf", 3, 26),
        Doc("static/rbicirc/MDfemaproptrnf.pdf", 2),
        Doc("static/rbicirc/MDfemaremitassets.pdf", 2, 6),
        Doc("static/rbicirc/MDFinservbybnks.pdf", 1, 19),
        Doc("static/rbicirc/MDforexothrremittancesMD.pdf", 1, 30),
        Doc("static/rbicirc/MDfraudrisksallbanks.pdf", 3, 18),
        Doc("static/rbicirc/MDitGRCassurnc.pdf", 4, 23),
        Doc("static/rbicirc/MDlrsguidelines.pdf", 3, 20),
        Doc("static/rbicirc/MDmsmelending.pdf", 1, 11),
        Doc("static/rbicirc/MDOmbudsman.pdf", 1),
        Doc("static/rbicirc/MDonFraudscombnks.pdf", 4, 34),
        Doc("static/rbicirc/MDonPSeclendg.pdf", 3, 39),
        Doc("static/rbicirc/MDPPIs.pdf", 1),
        Doc("static/rbicirc/MDregfrmMicrofinloans.pdf", 1, 18),
        Doc("static/rbicirc/RBIcomplguidelinesallbanks.pdf", 1),
        Doc("static/rbicirc/RBIMDSuprvreturns.pdf", 4),
        Doc("static/rbicirc/RBIMstrcircCustomerService.pdf", 12, 141),
        Doc("static/rbicirc/RBInotificKYCupdation.pdf", 1),
        Doc("static/iibfamlkyc.pdf", 6, 115),
        Doc("static/iibfprincbnkngorg.pdf", 5, 397),
        Doc("static/iibfdigitalbanking.pdf", 8, 58),
        Doc("static/iibfretforex.pdf", 5, 50),
        Doc("static/iibfcybrfraud.pdf", 73, 108),
    ]
